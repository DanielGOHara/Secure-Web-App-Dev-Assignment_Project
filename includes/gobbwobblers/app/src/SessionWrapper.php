...
/**
* SessionWrapper.php
* Description: A simple wrapper for getting/settings session data securely (as possible)
* Author: Lewis Harris
...
**/
 ...
 class SessionWrapper
 {
	...
	{
		//create a status check variable taht will be overwritten if data is found
		$val = false;
