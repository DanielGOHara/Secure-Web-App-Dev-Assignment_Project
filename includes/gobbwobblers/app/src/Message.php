<?php
/** Name: Message
*  Description: A Container for the M2MMessage - can contain data from both the M2MResponse, and the Database responses.
*  Author: Lewis Harris @ p2419279
*  Creation Data: 05/01/2021
**/
...
class Message
{
	...
	//use soap $response (from Gobbwobblers\M2mResponse() method) as input for the object
	...
	public function addM2M($response)
	{
		if (isset($response) && $response !== "")
		{
			...
			if (strpos($unpackedResponse->message, "gobbwobblers") == -1)
			{
				...
				$this->errors .= "M2M Response exists, but no message with 'gobbwobblers' identification";
