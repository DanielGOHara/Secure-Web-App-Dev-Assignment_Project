...
/**
* dependencies.php
* Description: Load the dependencies and attach relevant Pimple dependencies to the Slim container Object
* Authors: Lewis Harris, Daniel O'Hara
* Email: <p2419279@my365.dmu.ac.uk>, <p2435725@my365.dmu.ac.uk>
* Updated: 17/01/2021
**/

// Include gobbwobblers dependencies and namespaces
// Should be using pimple containers (like bottom of page) to adhere to PSR-11 but couldn't get it working
