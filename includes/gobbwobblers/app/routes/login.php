...
/**
* login.php
* Description: Gobbwobblers login and logged-out redirected from homepage
* Authors: Lewis Harris, Daniel O'Hara
* Email: <p2419279@my365.dmu.ac.uk>, <p2435725@my365.dmu.ac.uk>
* Updated: 17/01/2021
**/

//use request and response interfaces
...
$app->any('/login', function(Request $request, Response $response)
{
	...
	//declare variables to be used throughout the route
